	...
	<header>
		<div class="container">
			<div class="row" id="top-menu">
				...
				<div class="col-8 col-sm-8 col-lg-8 col-xl-8" align="right" id="top-menu-right">
		...
		<div class="frm-search" style="display: none;">
			<form action="#" method="get" id="right-search-form">
				...
				<button type="submit" id="search-btn">
					<img src="https://static.thenounproject.com/png/644045-200.png" width="16px" height="16px">
				</button>
			</form>
		</div>
		...
		<!-- 			로그인 팝업창  -->
		<div class="row">
	<div class="modal fade" id="myModal" data-backdrop="static" aria-hidden="true" style="display: none;">
	...
	<div id="header-bar" class="container">
		<div class="row" align="center">
			<div class="header-row">
               ...
               메뉴1 <img src="https://www.materialui.co/materialIcons/navigation/arrow_drop_down_black_192x192.png" alt="" width="32px">
               <!-- Dropdown -->
               <div id="dropdown" class="dropdown-content">
				...
				<div class="header-col">
					메뉴2 <img src="https://www.materialui.co/materialIcons/navigation/arrow_drop_down_black_192x192.png" alt="" width="32px">
				</div>

				<div class="header-col">
					메뉴3 <img src="https://www.materialui.co/materialIcons/navigation/arrow_drop_down_black_192x192.png" alt="" width="32px">
				</div>

				<div class="header-col">
					메뉴4 <img src="https://www.materialui.co/materialIcons/navigation/arrow_drop_down_black_192x192.png" alt="" width="32px">
				</div>
...
<!--                <li>별&nbsp;&nbsp;명 <input type="text" name="u_nick"></li> -->
               ...
               <li>가입일 <input type="text" name="u_email" readonly="readonly" value="${uv.u_date}"></li>
