...
<!-- 									<td class="board-info"></td> -->
  ...
  if(pg>BLOCK){
 %>
  [<a href="History.do?pg=1">◀◀</a>]
  [<a href="History.do?pg=<%=startPage-1%>">◀</a>]
 <%
  }
 %>
 <%
 ...
 <%
  if(endPage<allPage){
 %>
  [<a href="History.do?pg=<%=endPage+1 %>">▶</a>]
  [<a href="History.do?pg=<%=allPage %>">▶▶</a>]
 <%
  }
 %>
	   </div>
