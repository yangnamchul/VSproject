				...
				<div class="col-xs-12" id="joinDiv">
					...
					<ul class="vss-join" id="JoinForm">
						<li>아이디&nbsp;&nbsp; <input type="text" name="u_id" />
							<button type="button" class="checkbtn">중복검사</button> <br>
							<div>
						...
						<li>암&nbsp;&nbsp;호&nbsp;&nbsp; <input type="text" name="u_pw"
							class="password" /><br>
							...
							</div> <span class="progress-bar_text">칸이 비어있습니다</span>
						</li>
						<li>암호확인 <input type="text" name="u_pw_rep"
							...
							</div> <span class="progress-bar_re_text">칸이 비어있습니다</span>
						</li>
