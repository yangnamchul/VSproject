		...
		<div class="container" id="main">
			...
			<div class="row">
				<div class="col-12" id="replyDiv">
					<div id=replyTitle>댓글 (?개)</div>


					<ul id="replyUlist">

						<!-- 						list 반복 -->
						<li id="commnet_li" class="">
							<div id="reply-grid">
								<div class="#" id="reply-info">

									<div id="reply-vss">
										<span id="vss">부스러기</span>
									</div>
									<div id="reply-date">19. 8. 20. 21:46</div>
									<div id="reply-writer">작성자</div>
								</div>
						...
						<li id="commnet_li" class="">
							<div id="reply-grid">
								<div class="#" id="reply-info">
									...
									<div id="reply-date">19. 8. 20. 21:46</div>
									<div id="reply-writer">작성자2</div>
								</div>
								<div>222222222222222222222222 아무말 아무말아무말 아무말아무말 아무말아무말
									아무말아무말 아무말아무말 아무말?</div>
							</div>
						</li>
