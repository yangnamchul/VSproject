...
!function(a,b){
	...
	c=function(){
		...
		return r={
			...
			for(a in g)if(f.style[a]!==b){c=g[a],e=!0;break}
			...
			c=function(a){
				...
				q={
					...
					addListeners:function(a){
						...
						q=this;
						b=function(b){
							return"undefined"!=typeof b.preventDefault&&b.preventDefault(),i(b),
			...
			close:function(a,b){
				...
				this.bind(a,"click",function(){c(a)}),
					...
					c=function(a){
								"undefined"!=typeof a&&a.parentNode===m&&(f.transition.supported?(f.bind(a,f.transition.type,d),a.className+=" alertify-log-hide"):(m.removeChild(a),m.hasChildNodes()||(m.className+=" alertify-logs-hidden")))},0!==b&&setTimeout(function(){c(a)},e)},
			...
			notify:function(a,b,c){
				...
				e.innerHTML=a,m.appendChild(e),
				setTimeout(function(){
					e.className=e.className+" alertify-log-show"},50),this.close(e,c)},
			set:function(a){
				var b;
			...
			setup:function(a){
				var d,j=u[0],k=this;s=!0,d=function(a){
					...
					i="cancel"===q.buttonFocus?
							e:"none"===q.buttonFocus?c("alertify-noneFocus"):f,o=c("alertify-text")||
									b,n=c("alertify-form")||b,
