...
<link rel="stylesheet" type="text/css"
	href="resources/css/test/My_t.css" />
		...
		<div class="container" id="main">
			<div class="row">
				<div class="col-xs-12">
					...
					<div id="vss-reply-area">

						#button-comment, #button-comment-send { background-color: #BBBBBB;
						box-shadow: 2px 2px 0 #000000, -2px -2px 0 #FFFFFF; }

						<!-- 왼쪽 부분 (버튼) -->
						<div class="title buttons icon">
							<button id="button-comment" class="버튼 눌렀을때 적용 class">
								<svg class="normal">
									...
									<div class="textfield grid full">
										...
										<div class="guest">
											<input type="text" name="name" value="" class="content name"
												...
												class="content password" placeholder="비밀번호">
										</div>
								...
								<ul class="comments grid full">
									...
									<li id="comment15526830" class="comment grid full content">
										<div class="comment grid full">
											...
											<p>와! ㅋㅋㅋㅋ 이거 유용하겠aaaaaaaaaaaaaaㅋ 이거 유용하겠aaaaaaaaaaaaaaaㅋ
												이거 유용하겠aaaaaaaaaaaaaaaㅋ 이거 유용하겠aaaaaaaaaaaaaaaㅋ 이거
